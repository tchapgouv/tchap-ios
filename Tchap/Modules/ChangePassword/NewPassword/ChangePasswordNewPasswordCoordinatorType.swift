...
protocol ChangePasswordNewPasswordCoordinatorDelegate: AnyObject {
...
/// `ChangePasswordNewPasswordCoordinatorType` is a protocol describing a Coordinator that handle key backup setup passphrase navigation flow.
protocol ChangePasswordNewPasswordCoordinatorType: Coordinator, Presentable {
    var delegate: ChangePasswordNewPasswordCoordinatorDelegate? { get }
}
