...
@interface RoomAttachmentAntivirusScanStatusWithoutSenderInfoBubbleCell()
...
@implementation RoomAttachmentAntivirusScanStatusWithoutSenderInfoBubbleCell
...
{
    static RoomAttachmentAntivirusScanStatusWithoutSenderInfoBubbleCell *cell;
    static RoomAttachmentAntivirusScanStatusViewModelBuilder *attachmentAntivirusScanStatusViewModelBuilder;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        cell = [RoomAttachmentAntivirusScanStatusWithoutSenderInfoBubbleCell new];
        attachmentAntivirusScanStatusViewModelBuilder = [RoomAttachmentAntivirusScanStatusViewModelBuilder new];
    });
