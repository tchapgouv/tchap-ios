...
/// Protocol describing the view model used by `RoomAccessByLinkViewController`
protocol RoomAccessByLinkViewModelType {
        
    var titleViewModel: RoomTitleViewModel { get }
    
    var viewDelegate: RoomAccessByLinkViewModelViewDelegate? { get set }
