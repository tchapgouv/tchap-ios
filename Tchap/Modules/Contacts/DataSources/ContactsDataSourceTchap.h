...
typedef enum : NSUInteger
{
    ContactsDataSourceTchapUserDirectoryStateLoading,
    ContactsDataSourceTchapUserDirectoryStateLoadedButLimited,
    ContactsDataSourceTchapUserDirectoryStateLoaded,
    // The search is based on local known matrix contacts
    ContactsDataSourceTchapUserDirectoryStateOfflineLoading,
    ContactsDataSourceTchapUserDirectoryStateOfflineLoaded
} ContactsDataSourceTchapUserDirectoryState;


/**
 'ContactsDataSourceTchap' is a base class to handle contacts in Tchap.
 */
@interface ContactsDataSourceTchap : MXKDataSource <UITableViewDataSource, UIGestureRecognizerDelegate>
{
@protected
    // Section indexes
...
/**
 The state of the users search from the homeserver user directory.
 */
@property (nonatomic, readonly) ContactsDataSourceTchapUserDirectoryState userDirectoryState;
