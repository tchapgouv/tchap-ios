...
//                    .padding(.bottom)
                ...
                HStack() {
                    ...
                    Text(TchapL10n.welcomeTitle)
                        ...
                        .foregroundStyle(Color(ThemeService.shared().theme.textTertiaryColor))
                    Spacer()
                }
...
//        .readableFrame()
        ...
        HStack {
            ...
            Rectangle()
                .foregroundColor(Color(ThemeService.shared().theme.selectedBackgroundColor))
