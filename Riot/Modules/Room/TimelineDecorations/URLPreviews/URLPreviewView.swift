...
class URLPreviewView: UIView, NibLoadable, Themable {
    ...
    func update(theme: Theme) {
        ...
        siteNameLabel.textColor = theme.textSecondaryColor
        ...
        let closeButtonAsset = ThemeService.shared().isCurrentThemeDark() ? Asset_tchap.Images.urlPreviewCloseDark : Asset_tchap.Images.urlPreviewClose
