...
//    self.voiceMessageController = [[VoiceMessageController alloc] initWithThemeService:ThemeService.shared mediaServiceProvider:VoiceMessageMediaServiceProvider.sharedProvider];
...
- (RoomTimelineCellIdentifier)cellIdentifierForCellData:(MXKCellData*)cellData andRoomDataSource:(RoomDataSource *)customizedRoomDataSource;
{
    ...
    if (bubbleData.showAntivirusScanStatus)
    {
        ...
        {
            cellIdentifier = RoomTimelineCellIdentifierAttachmentAntivirusScanStatusWithPaginationTitle;
        }
        else if (bubbleData.shouldHideSenderInformation)
        {
            cellIdentifier = RoomTimelineCellIdentifierAttachmentAntivirusScanStatusWithoutSenderInfo;
        }
        else
        {
            cellIdentifier = RoomTimelineCellIdentifierAttachmentAntivirusScanStatus;
        }
    }
